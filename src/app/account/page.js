...
export default function Account() {
    ...
    const { user, addresses, setAddresses,
        addressFormData, setAddressFormData, componentLevelLoader, setComponentLevelLoader,
        pageLevelLoader, setPageLevelLoader
    } = useContext(GlobalContext)
    //check togleform address
            ...
            <div className='mx-auto bg-gray-100 px-4 sm:px-6 lg:px-8'>
                <div className='bg-white shadow'>
                    <div className='p-6 sm:p-12'>
                        ...
                        <div className='mt-6'>
                            <h1 className='font-bold text-lg'>You Addresses :</h1>
                            {
                                pageLevelLoader ? <PulseLoader
                                    color={"#000000"}
                                ...
                                /> : <div>
                                    {addresses && addresses.length
                                        ...
                                        : <p>address Found ! please a new address a below</p>}
                                </div>
                            }
                        </div>
                        <div className='my-4'>
                            <button
                                ...
                                className='mt-5  inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide'
                            >
                                {showAddressForm ? "Hide Address" : " Add New Address"}
                            </button>
                        </div>
                        {   //check togle
                            showAddressForm ?
