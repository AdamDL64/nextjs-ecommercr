...
export default function Checkout() {
    ...
    const publishableKey =
        "pk_test_51O32TCAMuQMIcPom9uiSZwUes8Uo3HTDHhl6mEMNFMD0tGZyeBZpcP4uUZGjSima1RJOpHjbenTqtFXj4tIAMZh900rWFURIaz";
    ...
    console.log(checkoutFormData,'checkput form data')
    return (
        <div>
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div className="mt-6 border-t border-b py-2">
                        ...
                        <div className="pb-10">
                            <button
                            //check ค่า ใน object shipping ว่ามีค่า ไหม กับ check cartitem ว่ามีค่าใหม่
                                disabled={  
