...
export default function CommonDetails({ item }) {
    ...
    //               <div className="g:order-2 lg:ml-5">
    //                 <div className="max-w-xl overflow-hidden rounded-lg">
    //                   <img
    //                     src={item.imageUrl}
    //                     alt="imageProduct Details"
    ...
    //             </h1>
    //           </div>
    //           <div className="mt-10 flex flex-col items-center justify-between space-x-4 border-t border-b py-4 sm:flex-row sm:space-x-0">
    ...
    //             <li className="flex items-center text-left text-sm font-sm font-medium text-gray-600">
